    ...
    const relatedWorks = [
        {
            ...
            content: [
                ...
                },
                {
                    title: "ภาษา ",
                    detail:
                        "รองรับ 1 ภาษา (ภาษาไทย) – เน้นใช้งานในประเทศไทย",
                },
                {
                    title: "เข้าชมเว็บไซต์ได้ที่ ",
                    detail:
                        "https://greenarea.dcce.go.th/",
                },
...
{/* Hero Section */}
            ...
            <div className="max-w-[1200px] mx-auto px-2 pt-12 md:pt-12 md:pb-4 relative border-b border-gray-300">
                <h1 className="text-3xl font-bold text-gray-800 tracking-[0.1em] uppercase mb-4">System Development</h1>
                <nav className="text-sm text-gray-600 mb-4 flex items-center gap-2">
                    ...
                    <Link href="/portfolio" className="hover:text-gray-800">ผลงานของเรา</Link>
                    <span className="text-gray-400">/</span>
                ...
                <div className="md:w-1/2 flex flex-col gap-6">
                    ...
                    >
                        {Title.gallery.map((img, idx) => (
                            <div
                                key={idx}
                                className={`flex-shrink-0 w-30 h-20 md:w-30 md:h-20 rounded-lg overflow-hidden cursor-pointer shadow-md transition-transform hover:scale-105 border-2 ${mainImage === img ? "border-white-400" : "border-transparent"}`}
                                onClick={() => {
